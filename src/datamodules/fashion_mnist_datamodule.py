...
class FashionMNISTDataModule(LightningDataModule):
    ...
    def __init__(
        self,
        data_dir: str = "data/",
        # this is also the default size (60k + 10k) for MNIST assosciated datasets
...
if __name__ == "__main__":
    ...
    """
        Here you associate the datamodule with a specific config file because
        it needs to be interchangeable.
    """
